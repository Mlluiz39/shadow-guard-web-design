    ...
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-security flex items-center gap-2">
          <Calculator className="h-6 w-6" /> Dashboard Financeiro
        </h1>
      ...
      <Card className="p-12">
        <CardContent className="flex flex-col items-center justify-center min-h-[300px] space-y-4">
          ...
          <CardTitle className="text-xl text-security">Dashboard Financeiro</CardTitle>
          <p className="text-security-muted text-center max-w-md">
            Esta seção está em desenvolvimento. Em breve você poderá visualizar relatórios e métricas financeiras.
          </p>
        </CardContent>
      </Card>
    </div>
