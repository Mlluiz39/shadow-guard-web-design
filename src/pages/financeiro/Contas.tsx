    ...
    <div className="container mx-auto p-4 space-y-6">
      ...
      <Card className="p-12">
        <CardContent className="flex flex-col items-center justify-center min-h-[300px] space-y-4">
          ...
          <CardTitle className="text-xl text-security">Contas</CardTitle>
          <p className="text-security-muted text-center max-w-md">
            Esta seção está em desenvolvimento. Em breve você poderá gerenciar todas as contas financeiras.
          </p>
        </CardContent>
      </Card>
    </div>
